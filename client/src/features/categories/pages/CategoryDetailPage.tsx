  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-[#0F2654]">
      ...
      <main className="mx-auto w-full max-w-6xl flex-grow px-6 py-10">
        <Link href="/categories" className="text-sm font-semibold text-blue-700 hover:text-blue-900">
          Back to categories
        </Link>
        <div className="mb-8 mt-4">
          <p className="text-sm font-semibold uppercase tracking-wide text-blue-700">Category</p>
        ...
        {isLoading ? (
          ...
          <p className="text-sm text-slate-500">No subcategories are available yet.</p>
        ) : (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {subcategories.map((subcategory) => (
              ...
              >
                ...
                <p className="mt-2 text-sm text-slate-600">Browse quiz types and questions.</p>
              </Link>
            ))}
          </div>
        )}
