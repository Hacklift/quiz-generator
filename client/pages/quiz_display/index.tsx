export { default } from "@features/quiz/pages/QuizDisplayPage";
"use client";
...
const QuizDisplayPage: React.FC = () => {
  ...
  const participantAccessMode =
    searchParams.get("participantAccessMode") === "restricted"
      ? "restricted"
      : "public";
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className="flex-1 flex justify-center px-4 sm:px-6 md:px-8 py-8">
        <div className="w-full max-w-4xl space-y-10">
          ...
          {!liveAccessCode && <LiveQuizAccessCodePanel quizId={quizId} />}
